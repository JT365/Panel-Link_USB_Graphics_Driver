...
//
int packageResetANSL(unsigned char * data,
	unsigned int * len)
{
...
//       out - length of SL payload
//
int packagePushSL(unsigned char * data,
	unsigned int * len)
{
	// check length of data       	
	if (*len < sizeof(STATUSLINK_TAG))
	...
	*len = sizeof(STATUSLINK_TAG);
	return (packageDummySL(data, TYPE_PUSH_STORAGE));
...
//       out - length of SL payload
//
int packageResetPLSL(unsigned char * data,
	unsigned int * len)
{
	// check length of data       	
	if (*len < sizeof(STATUSLINK_TAG))
...
//       out - length of SL payload
//
int packageResetSL(unsigned char * data,
	unsigned int * len)
{
	// check length of data       	
	if (*len < sizeof(STATUSLINK_TAG))
...
//       out - length of SL payload
//
int packageGetInfoSL(unsigned char * data,
	unsigned int * len)
{
	// check length of data       	
	if (*len < sizeof(STATUSLINK_TAG))
...
//
int depackGetInfoSL(unsigned char * data,
	unsigned int len,
	STATUSLINK_INFO * value)
{
	// check length of data       	
...
//       in - value of backlight level.
//
int packageSetBLSL(unsigned char * data,
                   unsigned int * len,
                   unsigned char value)
{
    // check length of data       	
...
//       in - value of backlight level.
//
int packageSetTimeSL(unsigned char * data,
                     unsigned int * len,
                     SYSTEMTIME * value)
{ 
    // check length of data       	
...
//       in - value of backlight level.
//
int packageGetTimeSL(unsigned char * data,
	unsigned int * len)
{
	// check length of data       	
	if (*len < sizeof(STATUSLINK_TAG))
	...
	*len = sizeof(STATUSLINK_TAG);
	return (packageDummySL(data, TYPE_GET_TIME));
}
...
//       in - value of backlight level.
//
int depackGetTimeSL(unsigned char * data,
	unsigned int len,
	SYSTEMTIME * value)
{
	// check length of data       	
